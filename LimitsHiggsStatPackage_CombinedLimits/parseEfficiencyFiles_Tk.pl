...
if ( $inAcceptance eq 1 ) {
  $infileStem = "InputData2012_Tk//EfficiencyFiles/efficiencies_coll_HTo2LongLivedTo4F";
} elsif ( $inAcceptance eq 2 ) {
  $infileStem = "InputData2012_Tk//EfficiencyFiles/efficiencyOverAcceptance/efficienciesOverAcceptance_coll_HTo2LongLivedTo4F";
} else {
...
my $ianfile;
if ($inAcceptance == 1) {
  $ianfile = "SignalSampleInfoEffi_Tk.py";
} elsif ($inAcceptance == 2) {
  $ianfile = "SignalSampleInfoEffiOverAcc_Tk.py";
}
