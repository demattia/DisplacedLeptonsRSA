...
if ( $inAcceptance eq 1 ) {
  $infileStem = "InputData2012_RSA//EfficiencyFiles/efficiencies_coll_HTo2LongLivedTo4F";
} elsif ( $inAcceptance eq 2 ) {
  $infileStem = "InputData2012_RSA//EfficiencyFiles/efficiencyOverAcceptance/efficienciesOverAcceptance_coll_HTo2LongLivedTo4F";
} else {
...
my %nominal_lifetimes = ("1000_350" => 350,
		         "1000_150" => 100,
		         "1000_50" => 40,
		         "1000_20" => 15,
		         "400_150" => 400,
...
my $ianfile;
if ($inAcceptance == 1) {
  $ianfile = "SignalSampleInfoEffi_RSA.py";
} elsif ($inAcceptance == 2) {
  $ianfile = "SignalSampleInfoEffiOverAcc_RSA.py";
}
