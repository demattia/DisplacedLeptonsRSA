...
if acceptanceOption%10 == 1:
    if jobOpt.doNeutralinoLimits:
       ...
       resultDirName = "counting_result_%s_neutralino"        %(jobOpt.limitMethod)
    else:
       jobDirName = "counting_job_%s"              %(jobOpt.limitMethod)
       jobOutName = "counting_job_output_%s"       %(jobOpt.limitMethod)
       resultDirName = "counting_result_%s"        %(jobOpt.limitMethod)
    ...
    if jobOpt.doNeutralinoLimits:
       ...
       resultDirName = "counting_result_acc_%s_neutralino"    %(jobOpt.limitMethod)
    else:
       jobDirName = "counting_job_acc_RSA_%s"          %(jobOpt.limitMethod)
       jobOutName = "counting_job_output_acc_%s"   %(jobOpt.limitMethod)
       resultDirName = "counting_result_acc_%s"    %(jobOpt.limitMethod)
else:
    sys.exit("ERROR: Unknown acceptance option %i" %(acceptanceOption) )

samples = getSignalSampleInfoRSA()
