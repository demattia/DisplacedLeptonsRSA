...
for index in range(10):
    ...
    scriptFile.write("""
cd /uscms_data/d3/demattia/DisplacedLeptons/RefittedStandAloneMuons/Analysis/CMSSW_5_3_8/src/
eval `scram runtime -sh`
cd -
cmsRun """+newCfgName+"""
cp """+outputFileName+""" /eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Cosmics/
rm """+outputFileName+"""
"""
)
    scriptFile.close()
