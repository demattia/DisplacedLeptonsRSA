...
COM_ENERGY = 13000 # GeV (centre-of-mass energy)
...
PYUPDA_CARDS = 'MCGeneration/TSGSamples/data/HTo2LongLivedTo%s_MH_%s_MFF_%s_CTau%s_pythia6.pyupda' % (FERMIONS, MASS_HIGGS, MASS_X, CTAU_X) # PYUPDA card file
