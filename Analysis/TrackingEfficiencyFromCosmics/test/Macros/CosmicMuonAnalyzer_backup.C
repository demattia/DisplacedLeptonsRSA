...
void CosmicMuonAnalyzer::Loop()
{
  ...
  TH1F * passingVsValidHits = new TH1F("passingVsValidHits", "tracks found vs valid hits", 75, 0., 75.);
  TH1F * totalVsValidHits = new TH1F("totalVsValidHits", "cosmics found vs valid hits (filled twice)", 75, 0., 75.);
...
//    if( muons->size() == 0 ) continue; 
    ...
    fillEff((*muons)[0].nValidHits, totalVsValidHits, tracks, passingVsValidHits);
